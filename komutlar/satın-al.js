...
exports.run = async (client, message, args) => {
  ...
  if (ürün === "tahta-olta") {
    ...
    return message.channel.send({
      content:
        ":tada: Tahta olta başarıyla satın alındı, kullanmak için: **!balık-tut**.",
      reply: { messageReference: message.id },
    });
    ...
    return message.channel.send({
      content:
        ":tada: Taş olta başarıyla satın alındı, kullanmak için: **!balık-tut**.",
      reply: { messageReference: message.id },
    });
    ...
    return message.channel.send({
      content:
        ":tada: Altın olta başarıyla satın alındı, kullanmak için: **!balık-tut**.",
      reply: { messageReference: message.id },
    });
    ...
    return message.channel.send({
      content:
        ":tada: Elmas olta başarıyla satın alındı, kullanmak için: **!balık-tut**.",
      reply: { messageReference: message.id },
    });
    ...
    return message.channel.send({
      content:
        ":tada:Tahta balta başarıyla satın alındı, kullanmak için: **!ağaç-kes**.",
      reply: { messageReference: message.id },
    });
    ...
    return message.channel.send({
      content:
        ":tada: Taş balta başarıyla satın alındı, kullanmak için: **!ağaç-kes**.",
      reply: { messageReference: message.id },
    });
    ...
    return message.channel.send({
      content:
        ":tada: Altın balta başarıyla satın alındı, kullanmak için: **!ağaç-kes**.",
      reply: { messageReference: message.id },
    });
    ...
    return message.channel.send({
      content:
        ":tada: Elmas balta başarıyla satın alındı, kullanmak için: **!ağaç-kes**.",
      reply: { messageReference: message.id },
    });
  } else {
    return message.channel.send({
