...
module.exports = {
    ...
    async execute(interaction, client) {
          ...
          if (times !== null && day - (Date.now() - times) > 0) {
            ...
            interaction.reply({ content: `Bu gün **${ödül} zCoin** kazandın! Bu komutu **${time.hours ? time.hours + "saat" : ""} ${time.minutes ? time.minutes + "dakika" : ""} ${time.seconds ? time.seconds + "saniye**": ""} sonra tekrar kullanabilirsin.`, ephemeral: true });
